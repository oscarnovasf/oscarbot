...
namespace Drupal\oscarbot_api\lib\swagger;
 ...
 */
final class SwaggerUiLibraryDiscovery implements ContainerInjectionInterface, CacheableDependencyInterface {

  /**
   * Swagger UI library path related cache ID.
   */
  private const LIBRARY_PATH_CID = 'oscarbot_api:library_path';
   ...
   *
   * @throws \Drupal\oscarbot_api\Exception\SwaggerUiLibraryDiscoveryException
   */
